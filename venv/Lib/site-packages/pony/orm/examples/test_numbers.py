...
#db.bind('mysql', host="https://api-hambuguer.coders4future.com", user="pony", passwd="pony", db="test_numbers")
#db.bind('postgres', user='pony', password='pony', host='https://api-hambuguer.coders4future.com', database='test_numbers')
#db.bind('oracle', 'test_numbers/pony@https://api-hambuguer.coders4future.com')
