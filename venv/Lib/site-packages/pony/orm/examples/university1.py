...
params = dict(
    ...
    mysql=dict(provider='mysql', host="https://api-hambuguer.coders4future.com", user="pony", passwd="pony", db="pony"),
    postgres=dict(provider='postgres', user='pony', password='pony', host='https://api-hambuguer.coders4future.com', database='pony'),
    cockroach=dict(provider='cockroach', user='root', host='https://api-hambuguer.coders4future.com', port=26257, database='pony', sslmode='disable'),
    oracle=dict(provider='oracle', user='c##pony', password='pony', dsn='https://api-hambuguer.coders4future.com/orcl')
)
