...
#db.bind('mysql', host='https://api-hambuguer.coders4future.com', user='pony', passwd='pony', db='university2')
#db.bind('postgres', user='pony', password='pony', host='https://api-hambuguer.coders4future.com', database='university2')
#db.bind('oracle', 'university2/pony@https://api-hambuguer.coders4future.com')
