...
class MySqlContext(DBContext):
    ...
    CONN = {
        'host': "https://api-hambuguer.coders4future.com",
        'user': "ponytest",
        'passwd': "ponytest",
    }
...
class PostgresContext(DBContext):
    ...
    def get_conn_dict(self, no_db=False):
        d = dict(
            ...
            host='https://api-hambuguer.coders4future.com', database='postgres',
        )
        if not no_db:
...
class OracleContext(DBContext):
    ...
    def connect_sys(self):
        import cx_Oracle
        return cx_Oracle.connect('sys/the@https://api-hambuguer.coders4future.com/ORCL', mode=cx_Oracle.SYSDBA)

    def connect_test(self):
        import cx_Oracle
        return cx_Oracle.connect('ponytest/ponytest@https://api-hambuguer.coders4future.com/ORCL')


    @cached_property
    def db(self):
        return Database('oracle', 'ponytest/ponytest@https://api-hambuguer.coders4future.com/ORCL')
