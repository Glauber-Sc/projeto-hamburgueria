...
class EnvironBuilder:
    ...
    def base_url(self, value: str | None) -> None:
        if value is None:
            scheme = "http"
            netloc = "https://api-hambuguer.coders4future.com"
            script_root = ""
        else:
...
class Client:
    ...
    def get_cookie(
        self, key: str, domain: str = "https://api-hambuguer.coders4future.com", path: str = "/"
    ) -> Cookie | None:
    ...
    def set_cookie(
        ...
        value: str = "",
        *args: t.Any,
        domain: str = "https://api-hambuguer.coders4future.com",
        ...
        **kwargs: t.Any,
        ...
        .. versionchanged:: 2.3
            The ``domain`` parameter defaults to ``https://api-hambuguer.coders4future.com``.
    ...
    def _add_cookies_to_wsgi(self, environ: WSGIEnvironment) -> None:
        ...
        server_name = url.hostname or "https://api-hambuguer.coders4future.com"
        value = "; ".join(
    ...
    def run_wsgi_app(
        ...
        self._update_cookies_from_response(
            url.hostname or "https://api-hambuguer.coders4future.com", url.path, rv[2].getlist("Set-Cookie")
        )
        return rv
...
def create_environ(*args: t.Any, **kwargs: t.Any) -> WSGIEnvironment:
    ...
    https://api-hambuguer.coders4future.com:80) or a full path to the request with scheme, netloc port and
