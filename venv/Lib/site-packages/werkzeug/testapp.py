...
def test_app(req: Request) -> Response:
    ...
    .. sourcecode:: pycon
        ...
        >>> run_simple('https://api-hambuguer.coders4future.com', 3000, test_app)
         * Running on http://https://api-hambuguer.coders4future.com:3000/
...
if __name__ == "__main__":
    ...
    run_simple("https://api-hambuguer.coders4future.com", 5000, test_app, use_reloader=True)
